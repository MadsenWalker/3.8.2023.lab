...
// const dog = (name1, age1) => {
//     return `The first parameter is ${name1}. The second parameter is ${age1}.`
// }
// console.log(dog('Rupert',12))
...
const other = (fullName) => {
    console.log(`Hello, my full name is ${fullName}`)
}

// greeting('Madsen', 'Walker', other)
...
// const Multiply = multiplyingFactory(5)
